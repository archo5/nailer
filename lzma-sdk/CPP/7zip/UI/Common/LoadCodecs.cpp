...
extern const CArcInfo *g_Arcs[kNumArcsMax];
...
DEFINE_GUID(CLSID_CArchiveHandler, 0x23170F69, 0x40C1, 0x278A, 0x10, 0x00, 0x00, 0x01, 0x10, 0x00, 0x00, 0x00);
static const UInt16 kDecodeId = 0x2790;
DEFINE_GUID(CLSID_CCodec, 0x23170F69, 0x40C1, kDecodeId, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);

void _refrc_BCJ2();
void _refrc_BCJ();
void _refrc_Branch();
void _refrc_ByteSwap();
void _refrc_Copy();
void _refrc_Delta();
void _refrc_LZMA2();
void _refrc_LZMA();

namespace NArchive { namespace NLzma {
  namespace NLzmaAr { void _refra_Lzma(); }
  namespace NLzma86Ar { void _refra_Lzma86(); }
}}
namespace NArchive { namespace NSplit { void _refra_Split(); } }
namespace NArchive { namespace NXz { void _refra_xz(); } }
void _refra_7z();
...
//RINOK(LoadDllsFromFolder(baseFolder + kFormatsFolderName TEXT(STRING_PATH_SEPARATOR)));
  ...
  NArchive::NLzma::NLzmaAr::_refra_Lzma();
  NArchive::NLzma::NLzma86Ar::_refra_Lzma86();
  NArchive::NSplit::_refra_Split();
  NArchive::NXz::_refra_xz();
  _refra_7z();
  ...
  #endif
  lib.CreateObject = (CreateObjectFunc)CreateObject;
  // LoadCodecs
  lib.GetMethodProperty = (GetMethodPropertyFunc)GetMethodProperty;
  UInt32 numMethods = 1;
  ...
  // LoadFormats
  GetHandlerPropertyFunc getProp = 0;
  GetHandlerPropertyFunc2 getProp2 = (GetHandlerPropertyFunc2)GetHandlerProperty2;
  UInt32 numFormats = 1;
  RINOK(::GetNumberOfFormats(&numFormats));
  for(UInt32 i = 0; i < numFormats; i++)
  {
