...
extern "C" int Main2()
{
	...
	commandStrings.Add(L"NOEXENAME");
	commandStrings.Add(L"a");
	commandStrings.Add(L"-r");
	commandStrings.Add(L"-t7z");
	commandStrings.Add(L"__nlr_tmparch.7z");
	commandStrings.Add(L"-mx9");
...
extern "C" int ar7z_compress_dir()
{
